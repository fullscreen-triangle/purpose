...
from domain_llm.trainer import TransformersTrainer
from domain_llm.inference import ModelInference, InteractiveInterface
...
@click.option("--output-name", default="domain_model", help="Name for the output model directory")
...
@click.option("--corpus-file", default="domain_corpus.txt", help="Name of the corpus file")
